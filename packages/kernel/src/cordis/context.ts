// @ts-nocheck
import type { Dict } from './cosmokit.ts'
...
export class Context {
  ...
  // These methods are installed by the built-in services at runtime. Keeping
  // the declarations on the class makes the flattened package declaration
  // self-contained; module augmentation alone is lost by declaration bundlers.
  declare get: (name: string, strict?: boolean) => any
  declare provide: (name: string, value?: any) => () => void
  declare inject: (
    deps: Inject,
